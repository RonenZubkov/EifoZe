    ...
    let prmLayers = this.http.get(this.baseUrl)
      ...
      .then(res => {
        ...
        return jsonLayers.map((jsonLayer : any) =>
          new LayerModel(jsonLayer.name, jsonLayer.symbol, jsonLayer.locs, jsonLayer._id))
      });
  ...
  get(id: string) : Promise<LayerModel> {
    let prmLayer = this.http.get(this.baseUrl + id)
      ...
      .then(res => {
        ...
        return new LayerModel(jsonLayer.name, jsonLayer.symbol, jsonLayer.locs, jsonLayer._id);
      });
